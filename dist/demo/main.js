...
module.exports = "body {\n  font-family: Lato;\n  font-size: 20;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ng2_toasty_1 = __webpack_require__(/*! ng2-toasty */ "./node_modules/ng2-toasty/index.js");
var ag_grid_angular_1 = __webpack_require__(/*! ag-grid-angular */ "./node_modules/ag-grid-angular/main.js");
...
var modal_service_1 = __webpack_require__(/*! ./services/modal.service */ "./src/app/services/modal.service.ts");
var app_component_1 = __webpack_require__(/*! ./app.component */ "./src/app/app.component.ts");
var list_component_1 = __webpack_require__(/*! ./components/list.component */ "./src/app/components/list.component.ts");
var title_component_1 = __webpack_require__(/*! ./components/title.component */ "./src/app/components/title.component.ts");
var focus_component_1 = __webpack_require__(/*! ./components/focus.component */ "./src/app/components/focus.component.ts");
var strikes_component_1 = __webpack_require__(/*! ./components/strikes.component */ "./src/app/components/strikes.component.ts");
var timer_component_1 = __webpack_require__(/*! ./components/timer.component */ "./src/app/components/timer.component.ts");
var grid_component_1 = __webpack_require__(/*! ./components/grid.component */ "./src/app/components/grid.component.ts");
var modal_component_1 = __webpack_require__(/*! ./components/modal.component */ "./src/app/components/modal.component.ts");
var AppModule = /** @class */ (function () {
    function AppModule() {
    }
    AppModule = __decorate([
        core_1.NgModule({
            imports: [platform_browser_1.BrowserModule, forms_1.FormsModule, ag_grid_angular_1.AgGridModule.withComponents([]), ng2_toasty_1.ToastyModule.forRoot()],
            declarations: [app_component_1.AppComponent, list_component_1.ListComponent, title_component_1.TitleComponent, focus_component_1.FocusComponent, strikes_component_1.StrikesComponent, timer_component_1.TimerComponent, grid_component_1.GridComponent, modal_component_1.ModalComponent],
            providers: [notification_service_1.NotificationService, event_service_1.EventService, modal_service_1.ModalService],
...
/***/ "./src/app/components/focus.component.ts":
/*!***********************************************!*\
  !*** ./src/app/components/focus.component.ts ***!
  \***********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var event_model_1 = __webpack_require__(/*! ../models/event.model */ "./src/app/models/event.model.ts");
var FocusComponent = /** @class */ (function () {
    function FocusComponent(eventService) {
        this.eventService = eventService;
    }
    FocusComponent.prototype.taskCompleted = function () {
        this.eventService.publishEventGetInfo(new event_model_1.EventModel("Task Complete", "Task X Completed", "Task"));
    };
    __decorate([
        core_1.Input()
    ], FocusComponent.prototype, "name", void 0);
...
/***/ "./src/app/components/grid.component.ts":
/*!**********************************************!*\
  !*** ./src/app/components/grid.component.ts ***!
  \**********************************************/
/*! no static exports found */
...
var GridComponent = /** @class */ (function () {
    function GridComponent(eventService) {
        var _this = this;
        this.eventService = eventService;
        ...
        this.columnDefs = [
            ...
            },
            {
                ...
                width: 140,
                cellRenderer: function (data) {
                    return _this.formatDate(data.value);
                },
            },
        ...
        this.dateRenderOptions = { hour: 'numeric', minute: 'numeric', month: 'numeric', day: 'numeric', year: 'numeric' };
    }
    GridComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.eventService.event.subscribe(function (event) {
            _this.insertRowWithDate(event.activity, event.comments, event.datetime, event.activityType);
        });
    ...
    GridComponent.prototype.clearData = function () {
        this.rowData = [];
    };
    GridComponent.prototype.formatDate = function (date) {
        return date ? (new Date(date)).toLocaleDateString('en-US', this.dateRenderOptions) : '';
    };
    GridComponent.prototype.insertRow = function (activity, comments) {
    ...
    GridComponent.prototype.insertRowWithDate = function (activity, comments, datetime, activityType) {
        this.rowData = this.rowData.concat([{ activity: activity, comments: comments, date: new Date(datetime), activityType: activityType }]);
        localStorage.setItem('focusData', JSON.stringify(this.rowData));
    };
    GridComponent.prototype.readFile = function ($event) {
        var _this = this;
        var file = $event.target.files[0];
        var myReader = new FileReader();
        myReader.onloadend = function () {
            _this.importData(myReader.result);
            $event.target.value = null;
        };
        myReader.readAsText(file);
    };
    GridComponent.prototype.importData = function (filestream) {
    ...
    GridComponent.prototype.save = function (filename, data) {
    ...
    GridComponent.prototype.mouseEnter = function () {
        this.mouseHover = true;
    };
    GridComponent.prototype.mouseLeave = function () {
        this.mouseHover = false;
    };
    GridComponent.prototype.isMouseHover = function () {
...
var ListComponent = /** @class */ (function () {
    ...
    ListComponent.prototype.newItemSubmit = function (item) {
...
var ModalComponent = /** @class */ (function () {
    function ModalComponent(modalService, eventService) {
        this.modalService = modalService;
        this.eventService = eventService;
        this.header = "Modal Header";
        this.body = "Modal Text";
        this.comment = "";
    }
    ModalComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.modalService.getModal().subscribe(function (data) {
            _this.modalOpen = data['isShowing'];
            _this.event = data['event'];
            _this.setHeader(_this.event);
            _this.setBody(_this.event);
        });
    };
    ModalComponent.prototype.commentChanged = function (event) {
        this.comment = event;
    };
    ...
    ModalComponent.prototype.submitModal = function () {
    ...
    ModalComponent.prototype.setHeader = function (event) {
    ...
    ModalComponent.prototype.setBody = function (event) {
        if (event.activityType === "Strike") {
...
/***/ "./src/app/components/strikes.component.ts":
/*!*************************************************!*\
  !*** ./src/app/components/strikes.component.ts ***!
  \*************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var strike_model_1 = __webpack_require__(/*! ../models/strike.model */ "./src/app/models/strike.model.ts");
var event_model_1 = __webpack_require__(/*! ../models/event.model */ "./src/app/models/event.model.ts");
var StrikesComponent = /** @class */ (function () {
    function StrikesComponent(notificationService, eventService) {
        this.notificationService = notificationService;
        this.eventService = eventService;
        this.strikes = [new strike_model_1.Strike(true), new strike_model_1.Strike(true), new strike_model_1.Strike(true)];
    }
    StrikesComponent.prototype.drawStrike = function (strike) {
        if (strike.isEmpty) {
    ...
    ;
    StrikesComponent.prototype.increment = function () {
        // Do stuff here
        //this.notificationService.info("Strike Recorded", "Strike Recorded");
        this.eventService.publishEventGetInfo(new event_model_1.EventModel("Strike Recorded", "No Comment", "Strike"));
    ...
    return StrikesComponent;
}());
exports.StrikesComponent = StrikesComponent;
;


/***/ }),

/***/ "./src/app/components/timer.component.ts":
/*!***********************************************!*\
  !*** ./src/app/components/timer.component.ts ***!
  \***********************************************/
/*! no static exports found */
...
var TimerComponent = /** @class */ (function () {
    function TimerComponent(eventService) {
        this.eventService = eventService;
        this.sessionTime = 45;
        this.breakTime = 10;
    ...
    TimerComponent.prototype.setBreak = function () {
        this.mode = "break";
    ...
    TimerComponent.prototype.setSession = function () {
        this.mode = "session";
        this.workTime = this.sessionTime;
        this.startTime = new Date();
        this.currentTime = new Date();
    ...
    TimerComponent.prototype.modeClick = function () {
        if (this.mode === "session") {
            if (this.secondsLeft() !== (this.sessionTime * 60))
                this.eventService.publishEvent(new event_model_1.EventModel("Session Ended", "", "SessionEnded"));
            this.setBreak();
        }
    ...
    TimerComponent.prototype.workTimeChanged = function (e) {
    ...
    TimerComponent.prototype.sessionTimeChanged = function (e) {
        console.log("Session Time Changed " + e);
        this.sessionTime = parseInt(e);
        this.restart();
    };
    TimerComponent.prototype.breakTimeChanged = function (e) {
    ...
    TimerComponent.prototype.update = function () {
        ...
        if (this.timerStarted) {
            if (this.secondsLeft() < 0) {
                if (this.mode === "session") {
                    this.eventService.publishEventGetInfo(new event_model_1.EventModel("Session Completed", "", "SessionComplete"));
                    this.mode = "break";
                    this.workTime = this.breakTime;
                    this.startTime = new Date();
                }
                    ...
                    this.workTime = this.sessionTime;
                    this.startTime = new Date();
                    this.eventService.publishEvent(new event_model_1.EventModel("Session Started", "", "SessionStart"));
                }
            }
            this.currentTime = new Date();
            this.fillHeight = this.percentFilled();
        }
        window.setTimeout(function () { return _this.update(); }, 500);
    };
    TimerComponent.prototype.clearTimeouts = function () {
        var id = window.setTimeout(function () { }, 0);
        while (id--) {
            window.clearTimeout(id); // will do nothing if no timeout with id is present
        }
    };
    TimerComponent.prototype.isBreakMode = function () {
        return this.mode === "break";
    };
    TimerComponent.prototype.percentFilled = function () {
        var secondsLeft = this.secondsLeft();
        return (((this.workTime * 60) - secondsLeft) / (this.workTime * 60)) * 100;
    };
    TimerComponent.prototype.secondsLeft = function () {
    ...
    TimerComponent.prototype.timeLeft = function () {
        var secondsLeft = this.secondsLeft();
        if (secondsLeft < 0) {
            secondsLeft = 0;
        }
    ...
    TimerComponent.prototype.click = function () {
        this.startTime = new Date();
        this.currentTime = new Date();
    ...
    TimerComponent.prototype.secondsToHms = function (d) {
        d = Number(d);
...
var TitleComponent = /** @class */ (function () {
    function TitleComponent(renderer2, elementRef) {
        this.renderer2 = renderer2;
        this.elementRef = elementRef;
        this.width = 350;
        this.editMode = false;
        this.mouseHover = false;
        this.talk = new core_1.EventEmitter();
    }
    TitleComponent.prototype.mouseEnter = function () {
        this.mouseHover = true;
    };
    TitleComponent.prototype.mouseLeave = function () {
        this.mouseHover = false;
    };
    TitleComponent.prototype.isMouseHover = function () {
        return this.mouseHover;
    };
    TitleComponent.prototype.toggleEditMode = function () {
    ...
    ;
    //yup....
    TitleComponent.prototype.focus = function () {
        var _this = this;
        window.setTimeout(function () {
            _this.renderer2.selectRootElement('#editInput').focus();
        });
    };
    TitleComponent.prototype.setTitle = function () {
    ...
    ], TitleComponent.prototype, "editInput", void 0);
    __decorate([
        core_1.Input()
    ], TitleComponent.prototype, "width", void 0);
    __decorate([
        core_1.Input()
    ], TitleComponent.prototype, "name", void 0);
    __decorate([
        core_1.Output()
    ], TitleComponent.prototype, "talk", void 0);
...
var EventModel = /** @class */ (function () {
    function EventModel(activity, comments, activityType) {
        this.activity = "";
        this.comments = "";
        this.activityType = "";
...
/***/ "./src/app/models/strike.model.ts":
/*!****************************************!*\
  !*** ./src/app/models/strike.model.ts ***!
  \****************************************/
/*! no static exports found */
...
var Strike = /** @class */ (function () {
    function Strike(empty) {
        this.isEmpty = true;
        this.isEmpty = empty;
    }
    Strike.prototype.set = function () {
        this.isEmpty = false;
    };
    return Strike;
}());
...
var EventService = /** @class */ (function () {
    ...
    EventService.prototype.publishEvent = function (event) {
        this.event.emit(event);
    };
    EventService.prototype.publishEventGetInfo = function (event) {
        this.modalService.open(event);
    };
    __decorate([
        core_1.Output()
    ], EventService.prototype, "event", void 0);
...
var ModalService = /** @class */ (function () {
    ...
    ModalService.prototype.open = function (event) {
        this.isShowing = true;
...
var NotificationService = /** @class */ (function () {
    ...
    ;
    NotificationService.prototype.displayToast = function (title, message, type) {
        var interval = 1000;
        var timeout = 5000;
...
module.exports = __webpack_require__(/*! /Users/quentinlautischer/Development/Focus Pomodoro/src/main.ts */"./src/main.ts");
